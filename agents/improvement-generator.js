...
- The "current" field MUST be an exact verbatim substring copied from the file contents above`
...
async function run(siteConfig) {
  ...
  const report = {
    ...
    summary: { generated: improvements.length, maxPerRun, minConfidence },
    improvements,
  };
